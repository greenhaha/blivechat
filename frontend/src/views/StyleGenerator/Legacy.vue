...
#medal-name.yt-live-chat-author-medal-renderer {
  ...
  line-height: ${this.form.medalLineHeight || this.form.medalFontSize - 4}px !important;
}
...
#medal-level.yt-live-chat-author-medal-renderer {
  ...
  height: 0;
  padding: 0;`}
  font-size: ${this.form.medalFontSize - 8}px !important;
  line-height: ${this.form.medalLineHeight || this.form.medalFontSize }px !important;
  min-width: ${this.form.medalLineHeight ? this.form.medalLineHeight + 10 : this.form.medalFontSize + 6}px !important;
}
`
    },
    messageStyle() {
